...
function plusMinus(arr) {
    ...
    //get number of positive numbers
    let positive = 0;
    
    //get number of negative numbers
    let negative = 0;
    
    //loop through array for length of array times
    ...
    //console.log the sum of each counter (zero, positive, negative) divided by the length of the array - the ratio
    console.log(positive / arr.length);
    console.log(negative / arr.length);
    console.log(numberOfZeros / arr.length);
}
